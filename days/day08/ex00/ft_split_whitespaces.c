...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/19 11:27:42 by vscippa           #+#    #+#             */
/*   Updated: 2019/07/19 13:44:59 by vscippa          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include <stdio.h>

int		ft_isword(char c, char cbefore)
{
...
int		*get_words_size(char *str)
{
	...
	words_size = (int *)malloc(words_count * sizeof(int))
	while (i <= words_count)
	{
		words_size[i] = 0;
		i++;
